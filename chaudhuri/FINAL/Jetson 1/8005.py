...
# === User Config ===
NUM_FRAMES_TO_PROCESS = 50  # number of frames to process before stopping
# This needs to be adapted to live view, not a set number of frames.
# It is currently only a set number of frames for testing purposes.
...
while frame_idx < NUM_FRAMES_TO_PROCESS:
    ...
    timestamp_ms = int(time.time() * 1000)  # current Unix time in milliseconds
